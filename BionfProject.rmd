...
**2. Established in epigenome-wide association studies (EWAS) [8]**
...
ggplot(plot_data, aes(x = Braak_stage, y = M_value)) +
  ...
  geom_smooth(method = "lm", se = TRUE, color = "darkcyan", fill = "#ff7f0e", 
...
* **Training set (80%)**: Used to fit the model, learn coefficients and optimize parameters.

* **Test set (20%)**: Used to evaluate performance in completely independent data that the model has never seen these samples, creating and honest assessment of generalization.

> 80/20 Split is a **Common standard** in machine learning that **balances**:
...
if (nrow(m_predictors_plot) > 0) {
  ...
  ggplot(m_predictors_plot, aes(x = Odds_Ratio, y = Label)) +
    ...
    scale_color_manual(values = c("FALSE" = "gray50", "TRUE" = "gold"),
...
1. https://pmc.ncbi.nlm.nih.gov/articles/PMC8397623/

2. https://www.nature.com/articles/npp2012112

3. https://www.sciencedirect.com/science/article/pii/S2667242125000405

4. https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE66351

5. https://pmc.ncbi.nlm.nih.gov/articles/PMC3012676/

6. https://life-epigenetics-methylprep.readthedocs-hosted.com/en/latest/docs/introduction/introduction.html

7. https://link.springer.com/article/10.1186/1471-2105-11-587

8. https://pmc.ncbi.nlm.nih.gov/articles/PMC5913606/#:~:text=Modelling%20approaches-,EWAS,i%20j%20+%20%CE%B5%20i%20j%20%2C

9. https://www.publichealth.columbia.edu/research/population-health-methods/false-discovery-rate

10. https://onlinelibrary.wiley.com/doi/10.1111/opo.12131