...
```{r download-data, cache=TRUE, message=FALSE, results='hide'}
...
```{r fit-linear-models, cache=TRUE}
...
# Fit models for all CpG sites (this takes time!)
cat("Fitting linear models for", nrow(m_values_valid), "CpG sites...\n")
...
cat("Successfully analyzed:", nrow(cpg_results), "CpG sites\n")
```
